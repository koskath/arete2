...
• Some gradients can still die out during backpropagation with a large learning rate –->
use Leaky ReLU.
• Leaky ReLU works by setting the activation to a small negative slope when the value
x < 0.
43
