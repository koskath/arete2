# Slide 36 of Lecture 9 contains information about the Vanishing Gradient Problem.

• Vanishing gradients make it difficult to know which direction the
parameters should move to improve the cost function.
