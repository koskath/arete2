...
• Possible to make trees more random by using random thresholds for each
feature.
• Easy to measure relative importance of each feature (weighted average).
• Ex: Trains a RandomForestClassifier on the iris dataset and outputs each
feature’s importance.
from sklearn.datasets import load_iris iris
sepal length (cm) 0.112492250999
= load_iris() sepal width (cm) 0.0231192882825
