# Here is what the image 1 in slide 13 of lecture 9 contains:

The image is organized into two columns. The left column features three activation functions: Sigmoid, tanh, and ReLU, each with labels and graphs. The right column displays Leaky ReLU, Maxout, and ELU, each with corresponding labels and graphs or equations.
