...
[A play button icon] [A horizontal progress bar mostly empty with a circular progress indicator towards the left] 00:27 / 12:31 [Speaker icon for volume control] 1x
