...
- **Colorado**: Computer-integrated systems and programming, Engineering services, Mining and oil and gas equipment
...
Each annotation is connected to its respective location on the map with a line for clarity. The map is stylized and does not include standard geographical features such as highways or borders between states.