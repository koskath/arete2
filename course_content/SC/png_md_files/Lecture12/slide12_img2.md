FIGURE 2.5 contains a structured table with multiple columns and rows, which details the gross and net requirement calculations for the snow shovel. The components of the table are as follows:
