...
def describe_image_with_gpt4o(image_path, additional_user_content=""):
    ...
    base_prompt = (
        "Describe what is in this image and connect it to supply chain analytics. Do not focus on the image itself, but on the content and the connection to supply chain analytics."
    )
        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "The description will be used as a substitute for the image in supply chain course notes, so it must precisely "
                    "describe every visible element relevant to diagrams, plots, formulas, supply chain architectures, axes, labels, data points, "
